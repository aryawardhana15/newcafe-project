  ...
  <div class="container relative">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 order-lg-2 mt-10 lg:mt-0" data-aos="fade-left" data-aos-delay="200">
        <div class="relative">
        <img src="{{ asset('assets/user/kopi.jpg') }}" class="img-fluid rounded-3xl shadow-2xl transform hover:scale-105 transition-transform duration-700" alt="Premium Coffee">
